...
<body>
    <form id="form1" runat="server">
        ...
        <br />&nbsp; 
            <asp:TextBox ID="txtSearch" runat="server"></asp:TextBox><asp:Button ID="btnPreview" runat="server" Text="View" OnClick="btnPreview_Click" />
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            gridviewScroll('#GridView2', 200, 6);
        });
